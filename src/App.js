  ...
  return (
    <Router>
      <div className="App">
        ...
        <footer class="footer">
            <p>Made by <a href="{{ site.url }}" class="footer-link">Zofia Korcz</a> using <a href="https://swapi.dev/">swapi</a>.</p>
            <p>Thank you for spending your time with me. <br/> Have a wonderful day!</p>
        </footer>
      </div>
    </Router>
  );
